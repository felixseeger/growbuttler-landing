      ...
      <main className={styles.main}>
        ...
        <section className={styles.section}>
          <div className={styles.field}>
            ...
            />
            {isPastDate() && (
              <small className={styles.warning}>⚠️ Image upload disabled for past dates</small>
            )}
          </div>
        </section>
        ...
        {/* Vitals, Nutrients, Narrative (same as before) */}
        <section className={styles.vitalsSection}>
          ...
          <div className={styles.vitalsContent}>
            <div className={styles.vitalItem}>
              ...
              <div className={styles.sliderWrap}>
                <div className={styles.sliderTrack}>
                  <div className={styles.sliderFill} style={{ width: `${((temperature - 70) / (90 - 70)) * 100}%` }}></div>
                </div>
            ...
            <div className={styles.vitalItem}>
              ...
              <div className={styles.sliderWrap}>
                <div className={styles.sliderTrack}>
                  <div className={styles.sliderFill} style={{ width: `${humidity}%` }}></div>
                </div>
        ...
        <section className={styles.nutrientSection}>
          ...
          <div className={styles.nutrientGrid}>
            <div className={styles.inputGroup}>
              ...
              <input type="text" placeholder="e.g. Flora Bloom" value={nutrientMix} onChange={(e) => setNutrientMix(e.target.value)} />
            </div>
            <div className={styles.inputGroup}>
              <label>pH Level</label>
              <input type="text" placeholder="6.2" value={phLevel} onChange={(e) => setPhLevel(e.target.value)} />
            </div>
          </div>
        </section>
