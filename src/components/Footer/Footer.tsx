...
interface FooterProps {
  tagline?: string
  platformLinks?: FooterLink[] | null
  communityLinks?: FooterLink[] | null
  legalLinks?: FooterLink[] | null
  copyrightText?: string
}

const defaultPlatform: FooterLink[] = [
  { label: 'Find Experts', url: '#' },
  { label: 'Journal', url: '#' },
  { label: 'Pricing', url: '#' },
]
const defaultCommunity: FooterLink[] = [
  { label: 'Forum', url: '#' },
  { label: 'Events', url: '#' },
  { label: 'Blog', url: '#' },
]
...
export default function Footer({
  ...
  const safeLegal = Array.isArray(legalLinks) && legalLinks.length > 0 ? legalLinks : defaultLegal
  return (
        ...
        <div className={styles.bottom}>
          ...
          <div className={styles.social}>
            <a href="#" className={styles.socialLink} aria-label="Instagram">
              <svg aria-hidden className={styles.socialIcon} fill="currentColor" viewBox="0 0 24 24">
